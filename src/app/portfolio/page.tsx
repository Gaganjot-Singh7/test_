...
import g1 from "../../../public/img/portfolio/g1.jpg";
import g2 from "../../../public/img/portfolio/g2.jpg";
import g3 from "../../../public/img/portfolio/g3.jpg";
...
import g1scroll from "../../../public/img/portfolio/g1scroll.jpg";
import g2scroll from "../../../public/img/portfolio/g2Scroll.jpg";
import g3scroll from "../../../public/img/portfolio/g3Scroll.jpg";
import grill from "../../../public/img/portfolio/grill.jpg";
import techcity from "../../../public/img/portfolio/techcity.jpg";
...
export default function Portfolio() {
  ...
  return (
    ...
    <meta property="og:description" content={PageMeta.description} />
      ...
      <Header />
      <div
        className="service-banner b2b-black-bg"
        style={{
          ...
          <div className="row flex-wrap align-items-center m-auto">
            <div className="col-12 col-sm-12 col-md-7 " data-aos="fade-up">
              ...
              <p className="text-white col-12 col-sm-12 col-md-10">
                Explore our diverse range of projects, each showcasing our
                dedication, creativity, and expertise in delivering exceptional
                                ...
                                <img
                                  ...
                                  onClick={() =>{ 
                                    if (typeof image.blank_image === "object" && "src" in image.blank_image) {
                                      openImageInNewTab(image.blank_image.src); // Safe access
                                    } 
                                    }}
                                />
                              </div>
