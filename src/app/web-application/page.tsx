...
export default function WebApplication() {
  ...
  return (
    ...
    <meta property="og:description" content={PageMeta.description} />
      ...
      <Header />
      <div className="b2b-black-bg" style={{backgroundImage: `url(${radialBg.src})`,backgroundRepeat: 'no-repeat',backgroundColor:"#111616"}}>
            ...
            <div className="row">
              <div className="col-md-8 text-center m-auto">
                ...
                <p
                  ...
                  data-aos-delay="300"
                >
                  We follow a streamlined process in our web development
                  service. From initial discovery to deployment and
                  optimization, each step is carefully executed to ensure your
                  website meets your goals, engages your audience effectively,
