                        ...
                        <form className="py-5" onSubmit={handleSubmit} data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div className="secondForm">
                                <div className="formRow mb-4 pb-2">
                                    ...
                                    <Select className="w-50" options={options} value={value} onChange={changeHandler} />
                                ...
                                <div className="formRow mb-4 pb-2">
                                    ...
                                    <input type="number" placeholder="7686788766" className="form-control removeBorder" name="mobileNo" value={formData.mobileNo} onChange={handleChange} 
