...
function Banner() {
  return (
    <>
     <div className="container-fluid mx-auto techcity_banner poppins" style={{backgroundImage: `url(${radialBg.src})`,backgroundRepeat: 'no-repeat'}}>
              <div className="row m-0 position-relative align-items-center text-white pt-md-5 pt-0 justify-content-center gap-3">
                ...
                >
                  <h2 className="b2b-sub-headings-bold-techcity ">
                  Boosting The <span className="techcity_detail_banner">techcity Father's</span> Burger Sales through Targeted Digital Marketing
